    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            לאורך 25 שנות הקריירה שלי, התמחיתי בתחומים רבים והתפתחתי ללא הרף. למדתי מהמומחים המובילים בעולם, כולל באקדמיות יוקרתיות בלונדון. יצרתי ליין מוצרים ייחודי שמשמש מקצועניות בכל הארץ. הכישרון והמקצועיות שלי זיכו אותי בהופעות בתוכניות טלוויזיה מובילות כמו "מילון היופי" ו"מרגישות יופי". המוטו שלי תמיד היה ויהיה: ללמוד, להתחדש ולהעניק את החוויה והתוצאה הטובה ביותר ללקוחה.
          </p>
        </div>
      </div>
      <BeforeAfter/>
