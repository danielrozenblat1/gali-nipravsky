...
import processImage from "../../images/מכשיר לייזר.png" // תמונה לתהליך העבודה
  ...
  const services = [
    {
      ...
      solutions: "פותרת תחושת חוסר ביטחון מול המראה, משחררת אותך מאיפור קבוע שאינך אוהבת, מנטרלת כהויות לא רצויות בשפתיים ובגבות, ומאפשרת לך להתחיל מחדש עם מראה טבעי ומדויק יותר",
    ...
    },
    {
      ...
      forWhom: "לאנשים שמאסו בקעקועים שלהם, מי שמעוניין להסיר קעקועי גוף או איפור קבוע כושל, ולמי שרוצה להתחיל מחדש עם מראה נקי יותר",
      includes: "פגישת ייעוץ חינם, בדיקת סוג הפיגמנט והערכת מספר טיפולים נדרשים, שימוש במכשיר לייזר מהמתקדמים בשוק, חומרי אלחוש להפחתת כאבים, וליווי מקצועי לאורך התהליך",
      message: "היי גלי הגעתי מהדף, אשמח לשמוע עוד על הסרת קעקועים באמצעות לייזר",
      solutions: "מאפשרת לך להיפרד מקעקועים שאינך אוהבת יותר, משחררת אותך מקעקועים שמזכירים לך תקופות חיים שהשתנו, ונותנת לך הזדמנות להתחיל מחדש או לעצב קעקוע אחר במקום",
    ...
    <div className={styles.servicesContainer}>
      ...
      <div className={styles.additionalInfoContainer}>
        <div className={styles.additionalInfo}>
          <h3 className={styles.infoTitle}>קצת על מכשיר הלייזר +BEAM - הטכנולוגיה המתקדמת לטיפולי פנים והסרת קעקועים</h3>
          <p>בסטודיו שלי אני משתמשת במכשיר +BEAM, מהמתקדמים בעולם לטיפולי פנים והסרת קעקועים. המכשיר פועל באורכי גל שונים המאפשרים לי להתאים את הטיפול בצורה מדויקת לצרכים השונים - בין אם מדובר בהסרת איפור קבוע, קעקועי גוף, או פילינג קרבון לחידוש העור.</p>
          <p>יתרונות מכשיר ה-+BEAM כוללים:</p>
          <ul className={styles.beamBenefitsList}>
            ...
            <li>מינימום אי-נוחות בזכות טכנולוגיית קירור מובנית</li>
            <li>תוצאות מהירות ונראות לעין</li>
            <li>פילינג קרבון ("פילינג הוליווד") להצערת העור ושיפור איכותו</li>
          </ul>
          <p>התהליך מתחיל בפגישת ייעוץ ללא עלות, בה אני מסבירה את הטיפול המתאים לך ומבצעת תיאום ציפיות מדויק. בין טיפול לטיפול יש הפסקה של חודש עד חודש וחצי, תלוי בגיל וסוג העור. בכל טיפול אני משתמשת בחומרי אלחוש איכותיים להפחתת הכאב למינימום. חשוב להבין שהתהליך דורש סבלנות לראות תוצאות, אך התוצאות שוות את ההמתנה ומביאות לשינוי משמעותי במראה ובתחושה.</p>
